package com.yuwei.adsense.interceptor;
...
public class AdSenseMvcInterceptor implements HandlerInterceptor {
    private static final long serialVersionUID = 1L;

    private static final Logger logger = LoggerFactory.getLogger(AdSenseMvcInterceptor.class);
